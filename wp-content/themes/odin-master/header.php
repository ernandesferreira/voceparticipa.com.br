...
<head>
	...
	<meta property="og:image" content="http://voceparticipa.com.br/wp-content/themes/odin-master/assets/images/logo.png">
	<!--[if lt IE 9]>
	...
	<div class="container">
		<header id="header" role="banner">
			...
			<div class=" col-md-6 logo">
				<a href="<?php echo home_url(); ?>"><img src='<?php bloginfo('template_directory'); ?>/assets/images/logo.png' width="300" alt='Você Participa' title='Você Participa'></a> 
			</div>
			<div class="col-md-6 chamada">
				<span class="title_chamada">Você quer uma cidade melhor para morar?
				<span class="sub-title-chamada"> Ajude a escolher o nome do nosso canal </span>
				</span>
			</div>
